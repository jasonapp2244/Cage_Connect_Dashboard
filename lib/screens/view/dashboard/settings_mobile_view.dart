...
class _SettingsMobileViewState extends State<SettingsMobileView> {
  int _selectedTab =
      -1; // -1 means showing card list, >= 0 means showing specific settings
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // Back button if viewing a specific settings screen
          if (_selectedTab != -1)
            Container(
          ...
          // Content: Either list of cards or specific settings content
          Expanded(
            child: _selectedTab == -1
                ? _buildSettingsCardList()
  ...
  Widget _buildSettingsContent() {
    ...
    switch (_selectedTab) {
      ...
      case 1:
        ...
        break;
      case 2:
        content = _buildNotificationsSettings();
        break;
      case 3:
        content = _buildSecuritySettings();
        break;
      case 4:
        content = _buildPaymentSettings();
        break;
      default:
