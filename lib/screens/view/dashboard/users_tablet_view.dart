    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 90, child: _TableHeader('Role')),
          SizedBox(width: 180, child: _TableHeader('Email')),
          SizedBox(width: 100, child: _TableHeader('Status')),
          SizedBox(width: 120, child: _TableHeader('Subscription')),
          SizedBox(width: 130, child: _TableHeader('Joined Date')),
          SizedBox(width: 110, child: _TableHeader('Action')),
        ],
      ),
    );
  }
